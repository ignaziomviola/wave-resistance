...
above $\Fn \approx 0.40$ the sweep runs at the static attitude, because the measured
attitude cannot be applied there, and a hull run \SI{31}{\milli\metre} too shallow makes
less wave. That accounts for the sign of the discrepancy above $\Fn = 0.40$ but not for the
